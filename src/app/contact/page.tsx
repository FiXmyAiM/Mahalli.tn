...
const pageMetadata = {
  title: 'Contact - Mahalli.tn | Contactez nos Experts Immobiliers',
  description: 'Contactez Mahalli.tn pour tous vos besoins immobiliers en Tunisie. Nos experts à Ben Arous vous accompagnent : 42 614 477 / 93 128 882. Devis gratuit sous 48h.',
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12">
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full h-12 px-3 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent bg-background text-foreground"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-3 py-3 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent resize-none bg-background text-foreground"
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    ...
                    className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 h-auto rounded-xl font-semibold text-base shadow-lg"
                  >
                    {isSubmitting ? (
                      <>
                  ...
                  <a
                    ...
                    className="flex-1 inline-flex items-center justify-center mahalli-bg-success hover:bg-success/90 text-success-foreground px-8 py-4 rounded-xl font-semibold text-base shadow-lg transition-colors"
                  >
              ...
              <div className="text-center py-12">
                <div className="w-20 h-20 bg-success/20 mahalli-success rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-card rounded-2xl p-8 shadow-xl">
            <div className="aspect-w-16 aspect-h-9 h-96 bg-muted/50 rounded-xl flex items-center justify-center">
